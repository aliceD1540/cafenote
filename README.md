...
ゲストノートとして使える匿名の掲示板システム。部屋ごとにコメント欄を設置でき、QRコードでアクセスを簡単に共有できます。

## 主な機能

### 基本機能
- 部屋ごとにゲストノート的なコメント欄を設置でき、コメントの閲覧・投稿ができる
- 部屋IDを含むURLをQRコード化してページ内に表示しておくことで、gogh内に掲示板への導線を作りやすくする
